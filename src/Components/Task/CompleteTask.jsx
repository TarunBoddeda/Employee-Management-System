...
const CompleteTask = () => {
  return (
    <div className="flex-shrink-0 w-[320px] h-fit p-3 rounded-lg bg-blue-400">
      ...
      <div className="mt-2 w-full">
        <button className="bg-blue-500 hover:bg-blue-600 px-3 py-1 rounded-md w-full text-white">
          Completed Task
        </button>
      </div>
    </div>
